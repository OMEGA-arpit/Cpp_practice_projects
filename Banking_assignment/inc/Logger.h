// Deprecated: include Messages.h directly. This header exists for backward compatibility.
#ifndef LOGGER_H
#define LOGGER_H
...
// Legacy content below retained for reference only — do not add new strings here.
namespace Logger_legacy_unused {
