...
public:
    MOCK_METHOD(const std::set<Song>&, getAllSongs, (), (const, override));
    MOCK_METHOD(const Song*, searchSong, (const std::string& title), (const, override));
    ...
    MOCK_METHOD(std::vector<std::string>, getPlaylistNames, (), (const, override));
